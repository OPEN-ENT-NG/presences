...
public interface MassmailingService {
     ...
     * @param punishmentsTypes punishmentsTypes list. Depends of structure parameter.
     * @param sanctionTypes    sanctionTypes list. Depends of structure parameter.
     ...
     */
    void getStatus(String structure, MassmailingType type, Boolean massmailed, List<Integer> reasons, List<Integer> punishmentsTypes,
                   List<Integer> sanctionTypes, Integer startAt, String startDate, String endDate, List<String> students,
                   boolean noReasons, Handler<Either<String, JsonObject>> handler);
     ...
     */
    void getStatus(String structure, MassmailingType type, boolean massmailed, List<Integer> reasons, List<Integer> punishmentsTypes,
                   List<Integer> sanctionTypes, Integer startAt, String startDate, String endDate, boolean noReasons,
     ...
     * @param handler          Function handler returning data
     */
    void getCountEventByStudent(String structure, MassmailingType type, Boolean massmailed, List<Integer> reasons,
                                List<Integer> punishmentsTypes, List<Integer> sanctionsTypes, Integer startAt,
                                String startDate, String endDate, List<String> students, boolean noReasons,
