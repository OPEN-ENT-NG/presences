const rights = {
    workflow: {
        ...
        readEvent: 'fr.openent.presences.controller.EventController.EventController|getEvents',
        createEvent: 'fr.openent.presences.controller.EventController.EventController|postEvent',
        readAbsentsCounts: 'fr.openent.presences.controller.EventController.EventController|getEvents',
