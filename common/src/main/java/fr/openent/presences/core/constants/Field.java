...
public class Field {
    ...
    public static final String ENDCOURSE = "endCourse";
    public static final String ENDMOMENTDATE = "endMomentDate";
    public static final String ENDMOMENTTIME = "endMomentTime";
    public static final String EVENTS = "events";
    public static final String EXCEPTIONNAL = "exceptionnal";
    ...
    public static final String STARTMOMENTDATE = "startMomentDate";
